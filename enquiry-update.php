...
if( isset($_POST['submit'])  ) {
	...
	if($sql) {
		...
		echo "<script type='text/javascript'>alert('Student details added successfully!!..');</script>";
					  echo "<script>document.location='addmission_enquiry.php'</script>";
	} else {
                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                ...
                                <li class="nav-item">
                                    <a href="all-admission-wenquiry.php" class="nav-link"><i class="fas fa-angle-right"></i>All
                                        Admission Enquiry</a>
                                </li>
                            </ul>
                        </li>
						<li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href=".php" class="nav-link"><i class="fas fa-angle-right"></i>
                                        </a>
                                </li>
                                <li class="nav-item">
                                    <a href=".php" class="nav-link"><i class="fas fa-angle-right"></i>
