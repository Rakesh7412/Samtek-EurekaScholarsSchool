                                ...
                                <tbody>
                                     <?php
                                        ...
                                        <tbody id="geeks">
                                            <tr>
                                                <td><?php echo $i; ?></td>
                          <td><?php echo $row1['tfirstname' ];?>-<?php echo $row1['tmiddlename' ];?>-<?php echo $row1['tlastname' ];?></td>
						  <td><?php echo $row1['tcampus'];?></td>
						  <td><?php echo $row1['temail'];?></td>
						  <td><?php echo $row1['tmobile'];?></td>
						  <td><?php echo $row1['tgender'];?></td>
						  <td><?php echo $row1['tdob'];?></td>
						  <td><?php echo $row1['taddress'];?></td>
						  <td><?php echo $row1['tcity'];?></td>
						   <td><a href="update-teacher.php?staffid=<?php echo $row1['tid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
					 
						<a href="delete-teacher.php?staffid=<?php echo $row1['tid']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
						 <?php $i++;  } ?>
                                            </tr>
                                </tbody>
                            </table>
