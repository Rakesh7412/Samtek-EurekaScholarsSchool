...
<body>
 ...
 <div class="certificate-container">
    <div class="certificate">
       ...
       <center> <div class="certificate-header">
            <img src="img/logo (1).png" class="logo" alt="">
        </div></center>
        <div class="certificate-body">
           
           <center>
            <h2><b>BONAFIDE CERTIFICATE</b></h2></center>
           <br>
            <div class="certificate-content">
                ...
                <div class="text-center">
				  ...
				  $results1 = mysqli_query($conn, "select * from studentdetails ");
                $row1 = mysqli_fetch_array($results1);
			
				  ?>
                    <p  style="color:black;" align="justify">This is to certify that Miss/Mst.&nbsp;<input type="text" name="name" id="input" value="<?php echo $row1['sfirstname'];?> <?php echo $row1['smiddlename'];?> <?php echo $row1['slastname'];?>"style="border:1px solid white;">is a bonafide student of our school. She/He is studying in std. <input type="text" name="name" id="input2" value="<?php echo $row1['class'];?>"style="border:1px solid white;">in the academic year 20_______.Her/His General Register No.is _______.Her/His date of birth according to our General Register is&nbsp;<input type="text" name="name" id="input" value="<?php echo $row1['sdob'];?>"style="border:1px solid white;">and place of birth is&nbsp; <input type="text" name="name" id="input" value="<?php echo $row1['place_of_birth'];?>"style="border:1px solid white;">.Her/His caste as mentioned in the General register is&nbsp;<input type="text" name="caste" id="input5" value="<?php echo $row1['scaste'];?>"style="border:1px solid white;">and her/his mother’s name is&nbsp;<input type="text" name="name" id="input" value="<?php echo $row1['smname'];?>"style="border:1px solid white;">. Bonafide is issued for __________________________________.
 ...
 <!-- </form></div><button class="btn btn-dark" class="html2PdfConverter" onclick="createPDF()">Export to PDF </button> -->
 <input type="button" onclick="printDiv('print-content')" value="Print" class="btn btn-dark" id="btn">
