...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"update transport_student_staff set choice='$choice',stud_name='$stud_name',staff_name='$staff_name',class='$class',vehicaltype='$vehicaltype',destination='$destination',picku='$picku',dropu='$dropu',route='$route' ,date='$date',charge='$charge',pending='$pending' where ssid='$id'") or die(mysqli_error($conn));
									...
									<label>Student Name</label>
										<div class="col-sm-18">
                                           <select name="stud_name" class="form-control">
											<option value="">Please select</option>
											<?php 
												$sql=mysqli_query($conn,"select * from studentdetails");
												while($row=mysqli_fetch_array($sql)) {
											?>
											<option value="<?php echo $row['sid']; ?>"><?php echo $row['sfirstname']; ?>-<?php echo $row['slastname']; ?></option><?php } ?>
									...
									<div class="col-xl-4 col-lg-6 col-12 form-group">
										...
										<div class="col-sm-18">
                                           <select name="staff_name" class="form-control">
											<option value="">Please select</option>
											<?php 
												$sql=mysqli_query($conn,"select * from staffdetails");
												while($row=mysqli_fetch_array($sql)) {
											?>
												<option value="<?php echo $row['tid']; ?>"><?php echo $row['tfirstname']; ?>-<?php echo $row['tlastname']; ?></option><?php } ?>
												<option value="NA">NA</option>
											</select>
                                        </div>
									</div>
									<div class="col-xl-4 col-lg-6 col-12 form-group">
										...
										<div class="col-sm-18">
                                           <select name="class" class="form-control">
											<option value="">Please select</option>
											<?php 
												$sql=mysqli_query($conn,"select * from tblclasses");
												while($row=mysqli_fetch_array($sql)) {
											?>
												<option value="<?php echo $row['id']; ?>"><?php echo $row['ClassName']; ?>-<?php echo $row['Section']; ?></option><?php } ?>
												<option value="NA">NA</option>
											</select>
                                        </div>
									</div>
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
										...
										<div class="col-sm-18">
                                           <select name="source" class="form-control">
											<option value="">Please select</option>
											<?php 
												$sql=mysqli_query($conn,"select * from transport");
												while($row=mysqli_fetch_array($sql)) {
											?>
												<option value="<?php echo $row['vid']; ?>"><?php echo $row['source']; ?></option><?php } ?>
											</select>
                                        </div>
								</div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
										...
										<div class="col-sm-18">
                                           <select name="destination" class="form-control">
											...
											<?php 
												...
												while($row=mysqli_fetch_array($sql)) {
											?>
												<option value="<?php echo $row['vid']; ?>"><?php echo $row['destination']; ?></option><?php } ?>
											</select>
                                        </div>
								</div>
								<?php
                                        $sql=mysqli_query($conn,"select * from transport_student_staff where ssid='$id' ");
				while($row=mysqli_fetch_array($sql)) 
				{
				?>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                <input type="hidden" class="form-control" name="ssid" value="<?php echo $id; ?>">
                                    <label>Pick Up Time</label>
                                    <input type="time" placeholder="" name="picku" class="form-control" value="<?php echo $row['picku']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Drop Time</label>
                                    <input type="time" placeholder="" name="dropu" class="form-control" value="<?php echo $row['dropu']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Routes</label>
                                    <input type="text" placeholder="Routes" name="route" class="form-control" value="<?php echo $row['route']; ?>">
                                </div>
                                
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Transport Join Date</label>
                                    <input type="date" placeholder="" name="date" class="form-control" value="<?php echo $row['date']; ?>">
                                </div>
								
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Transport Charges</label>
                                    <input type="text" placeholder="Transport Charges" name="charge" class="form-control air-datepicker" data-position='bottom right' value="<?php echo $row['charge']; ?>">
                                </div>
                                
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Transport Charges Pending</label>
                                    <input type="text" placeholder="Transport Charges Pending" name="pending" class="form-control" value="<?php echo $row['pending']; ?>">
                                </div>
                                <?php } ?>
