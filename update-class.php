...
if( isset($_POST['Submit'])  ) {
	...
	$sql = mysqli_query($conn,"update tblclasses set ClassName='$ClassName',ClassNameNumeric='$ClassNameNumeric',Section='$Section' where id='$id'") or die(mysqli_error($conn));
...
<body>
  ...
  <br> 
    ...
    <?php
				$sql=mysqli_query($conn,"select * from tblclasses where id='$id'");
                ...
                <input type="hidden" class="form-control" name="id" value="<?php echo $id; ?>">
				  ...
				  <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="ClassName" id="exampleInputEmail1" placeholder="Eg- Third, Fouth,Sixth etc" value="<?php echo $row['ClassName']; ?>">
                  </div>
				  
				   
				  <div class="col-md-4">
                    <label for="exampleInputEmail1">Class Name In Numeric</label>
                    <input type="number" name="ClassNameNumeric" required="required" class="form-control" id="success"placeholder="Eg- 1,2,4,5 etc"value="<?php echo $row['ClassNameNumeric']; ?>">
                    <!-- <input type="text" class="form-control" name="csmname" id="exampleInputEmail1" placeholder="Eg- 1,2,4,5 etc"> -->
                  </div>
				  
				   <div class="col-md-4">
                    <label for="exampleInputEmail1">Section</label>
                    <input type="text" class="form-control" name="Section" id="exampleInputEmail1" placeholder="Eg- A,B,C etc" value="<?php echo $row['Section']; ?>">
                  </div>
				   </div></div>
				  <?php }?>
