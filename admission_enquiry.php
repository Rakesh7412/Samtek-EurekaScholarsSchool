...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"INSERT INTO office_enq(enqdate,childName,age,sgender,class,saddress,PschoolName,PschoolBoard,PschoolLeave,sfname,Occupation,FatherMNo,femail,smname,MOccupation,MotherMNo,memail,Come,enqhandle,enqtype,remark,followup,status)VALUES ('$EnqDate','$ChildName','$Age','$Gender','$Class','$studetnAddress','$PschoolName','$PschoolBoard','$PschoolLeave','$FatherName','$FOccupation','$FatherMNo','$Femail','$MotherName','$MOccupation','$MotherMNo','$memail','$Come','$enqhandle','$enqtype','$remark','$followup','$status')") or die(mysqli_error($conn));
	
    // INSERT INTO `office_enq` (`Oid`, `enqdate`, `childName`, `age`, `sgender`, `class`, `saddress`, `PschoolName`, `PschoolBoard`, `PschoolLeave`, `sfname`, `Occupation`, `FatherMNo`, `femail`, `smname`, `MOccupation`, `MotherMNo`, `memail`, `Come`, `enqhandle`, `enqtype`, `remark`, `follow1`, `date1`, `time1`, `follow2`, `date2`, `time2`, `follow3`, `date3`, `time3`, `follow4`, `date4`, `time4`) VALUES (NULL, '22/02/22', 'trrr', 'ttttr', 'rrrr', 'gggg', 'gggg', 'fdv dcv', 'fvfv', 'dv dv', 'fdvsdvd', 'cvdcvs', 'vcsv', 'scv@gmail.com', 'sdcv', 'scvfdv', 'vvvverfvew', 'wervwefv@gmail.com', 'fdwfdwef', 'efwerf', 'wferfrwer', 'rfwerf', 'ewdfwef', 'ewfwef', 'erwfwewdf', 'rfrfg', 'gdfesre', 'erffer', 'ferfe', 'ferfe', 'erferf', 'erferf', 'erferf', 'efrferf');
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="date" placeholder="dd/mm/yyyy" name="enqdate" class="form-control air-datepicker" data-position='bottom right'>
                                   
                                </div>
								
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Name of Child</label>
                                    <input type="text" placeholder="Name of Child" name="childName" class="form-control">
                                </div>
								...
								<div class="col-lg-12 col-8 form-group">
                                    ...
                                    <textarea class="textarea form-control" name="saddress" id="form-message" cols="10" rows="8"></textarea>
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Previous School Name</label>
                                    <input type="text" placeholder="Previous School Name" name="PschoolName" class="form-control">
                                </div>
								
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Previous School Board</label>
                                    <input type="text" placeholder="Previous School Board" name="PschoolBoard" class="form-control">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Previous School Leaving Reason</label>
                                    <input type="text" placeholder="Previous School Leaving Reason" name="PschoolLeave" class="form-control">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Student's Father Name</label>
                                    <input type="text" placeholder="Student's Father Name" name="sfname" class="form-control">
                                </div>
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Father Mobile Number" name="FatherMNo" class="form-control">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Father Email Id</label>
                                    <input type="text" placeholder="Father Email Id" name="femail" class="form-control">
                                </div>
                                
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Student's Mother Name</label>
                                    <input type="text" placeholder="Student's Mother Name" name="smname" class="form-control">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Mother Occupation</label>
                                    <input type="text" placeholder="Occupation" name="MOccupation" class="form-control">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Mother Mobile Number</label>
                                    <input type="text" placeholder="Mother Mobile Number" name="MotherMNo" class="form-control">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Mother Email Id</label>
                                    <input type="text" placeholder="Mother Email Id" name="memail" class="form-control">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>How do you come to know about Eureka School?</label>
                                    <input type="text" placeholder="About Eureka School" name="Come" class="form-control">
                                </div>
								
                                 <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Enquiry Handled By</label>
                                    <input type="text" placeholder="Enquiry Handled By" name="enqhandle" class="form-control">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Enquiry Type</label>
                                    <input type="text" placeholder="Walk-in / Telephonic / Other" name="enqtype" class="form-control">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Remarks by Admission counsellor</label>
                                    <input type="text" placeholder="Remarks by Admission counsellor" name="remark" class="form-control">
                                </div>
								
                                <div class="col-lg-12 col-8 form-group">
                                    <label>Followup</label>
                                    <textarea class="textarea form-control" name="followup" id="form-message" cols="10" rows="8"></textarea>
                                </div>
								
								<div class="col-lg-12 col-8 form-group">
                                    <label>Status</label>
                                    <textarea class="textarea form-control" name="status" id="form-message" cols="10" rows="8"></textarea>
                                </div>
