...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"update parentgate set sfirstname='$sfirstname',smiddlename='$smiddlename',slastname='$slastname',class='$class',section='$section',person='$person',relation='relation',mobile='$mobile',reason='$reason',date='$date',outtime='$outtime' where prntgid='$id'") or die(mysqli_error($conn));
                    ...
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <?php
                                        $sql=mysqli_query($conn,"select * from parentgate where prntgid='$id'");
				while($row=mysqli_fetch_array($sql)) 
				{
				?>
                                    <label>First Name</label>
                                    <input type="hidden" class="form-control" name="prntgid" value="<?php echo $id; ?>">
                                ...
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Middle Name" name="slastname" class="form-control" value="<?php echo $row['slastname']; ?>">
                                </div>
								...
								<div class="col-12 form-group mg-t-8">
                                    <button type="submit" value="submit" name="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Save</button>
                                </div>
                            </div>
                        </form>
                    </div>
