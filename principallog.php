...
if( isset($_POST['login'])  ) {
 ...
 if ($conn->connect_error) {
        ...
        $ret=mysqli_query( $conn, "SELECT * FROM userslogin WHERE email='$email' and Password='$password' and cat='Principal'") or die("Could not execute query: " .mysqli_error($conn));
        ...
        if(!$row) {
           ...
           echo "<script>document.location='principallogin.php'</script>";
        }
        else {
...
<body>
  ...
  <center>
  <h1 style="color:#C82128;">Welcome Principal ESS</h1></center>
<div class="login-box">
