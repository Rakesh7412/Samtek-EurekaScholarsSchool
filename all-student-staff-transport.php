           ...
           <!-- Sidebar Area Start Here -->
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>Students_Staff Details</h3>
                    <ul>
                        <li>
                            <a href="index1.php">Home</a>
                        </li>
                        <li>Students_Staff</li>
                    </ul>
                </div>
									...
									<tr>
										<th>
                                            <div class="form-check">
												...
												<th>Drop Time</th>
												<th>Routes</th>
												<th>Transport Join Date</th>
												<th>Transport Charges</th>
												<th>Transport Charges Pending</th>
												<th>Action</th>
											</tr>
                                        </thead>
										 <?php
										  ...
										  $results1 = mysqli_query($conn, "select * from transport_student_staff");
                                        ...
                                        <tbody id="geeks">
                                            <tr>
                                                <td><?php echo $i; ?></td>
												  ...
												  <td><?php echo $row1['picku'];?></td>
												  <td><?php echo $row1['dropu'];?></td>
												  <td><?php echo $row1['route'];?></td>
												  <td><?php echo $row1['date'];?></td>
												  <td><?php echo $row1['charge'];?></td>
												  <td><?php echo $row1['pending'];?></td>
												  <td>
												  <a href="update-student-staff-transport.php?ssrid=<?php echo $row1['ssid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
												  <a href="delete-student-staff-transport.php?ssrid=<?php echo $row1['ssid']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
													<?php $i++;  } ?>
														</tr>
                                </tbody>
                            </table>
