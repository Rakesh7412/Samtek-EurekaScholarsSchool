                    ...
                    <li class="navbar-item dropdown header-admin">
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-expanded="false">
                            <div class="admin-title">
                                <h5 class="item-title">Eureka Zone</h5>
                                <span>Admin</span>
                            </div>
                            <div class="admin-img">
                ...
                <div class="card height-auto">
                    <div class="card-body">
						...
						<div class="table-responsive">
                           ...
                           <tr>
                          <td><?php echo $i; ?></td>
                          <td><?php echo $row1['sfirstname' ];?> <?php echo $row1['smiddlename' ];?> <?php echo $row1['slastname' ];?></td>
						  ...
						  <td><?php echo $row1['scaste'];?></td>
						  <td><?php echo $row1['nationality'];?></td>
						  <td><?php echo $row1['sdob'];?></td>
						  <td><?php echo $row1['place_of_birth'];?></td>
						  <td><?php echo $row1['saddress'];?></td>
						  <td><?php echo $row1['scity'];?></td>
						  <td><?php echo $row1['shobbies'];?></td>
						  <td> <a href="certificates.php?sid=<?php echo $row1['sid']; ?>"><button class="btn btn-warning b"><b>Cerificates</b></button></a></i></a></td>
											

                          <td><a href="student-update.php?studentid=<?php echo $row1['sid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
					 
						  <a href="student-delete.php?studentid=<?php echo $row1['sid']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
						  <?php $i++;  } ?>
