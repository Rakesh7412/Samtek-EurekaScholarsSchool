...
if( isset($_POST['register'])  ) {
	...
	$sql = mysqli_query($conn,"INSERT INTO userslogin(name,email,password,address,cat)VALUES ('$name','$email','$password','$address','principal')") or die(mysqli_error($conn));
	
	if($sql) {
		
		echo "<script type='text/javascript'>alert('Registered successfully!!..');</script>";
					  echo "<script>document.location='principal-reg.php'</script>";
	} else {
           ...
           <!-- Sidebar Area Start Here -->
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>Principal User Register</h3>
                    <ul>
                        <li>
                            <a href="index1.php">Home</a>
                        </li>
                        <li>Principal User Register</li>
                    </ul>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <form class="mt-5 mb-5 login-input" action="" method="post">
								<div class="form-group">
                                        <input type="name" class="form-control" placeholder="Principal Name" name="name" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="email" class="form-control" placeholder="Principal Email" name="email"required>
                                    </div>
                                    <div class="form-group">
