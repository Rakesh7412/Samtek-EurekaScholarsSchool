...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"update staffgate set ename='$ename',designation='$designation',outtime='$outtime',intime='$intime',reason='$reason',date='$date' where sid='$id'") or die(mysqli_error($conn));
	...
	if($sql) {
		...
		echo "<script type='text/javascript'>alert('error while updating student details!!..');</script>";
					  echo "<script>document.location='manage_staffgate.php'</script>";
	} 
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            ...
                            <?php
                                        $sql=mysqli_query($conn,"select * from staffgate where sid='$id'");
				...
				?>
                                ...
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Name of Employee" name="ename" class="form-control" value="<?php echo $row['ename']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Designation</label>
                                    <input type="text" placeholder="Designation" name="designation" class="form-control" value="<?php echo $row['designation']; ?>">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>In Time</label>
                                    <input type="time" placeholder="In Time" name="intime" class="form-control" value="<?php echo $row['intime']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
