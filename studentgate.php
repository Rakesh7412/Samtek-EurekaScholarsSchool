...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"INSERT INTO studentgate(sfirstname,smiddlename,slastname,class,section,person,relation,mobile,reason,date,outtime)VALUES ('$sfirstname','$smiddlename','$slastname','$class','$section','$person','$relation','$mobile','$reason','$date','$outtime')") or die(mysqli_error($conn));
