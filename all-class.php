           ...
           <!-- Sidebar Area Start Here -->
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
				  ...
				  $results1 = mysqli_query($conn, "select * from tblclasses");
				  ...
				  ?>
						  ...
						  <td><?php echo $row1['ClassNameNumeric'];?></td>
                          <td><?php echo $row1['Section'];?></td>
                          <td><?php echo $row1['CreationDate'];?></td>
                          <td><?php echo $row1['UpdationDate'];?></td>
						  
                          <td><a href="update-class.php?classid=<?php echo $row1['id']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
					 
						  <a href="delete-class.php?classid=<?php echo $row1['id']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
							<?php $i++;  } ?>
                                    </tr>
                                </tbody>
                            </table>
