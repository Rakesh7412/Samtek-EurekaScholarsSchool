        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
				  ...
				  $results1 = mysqli_query($conn, "select * from playgrp_fees");
				  ...
				  ?>
                                        ...
                                        <tr>
                                                <td><?php echo $i; ?></td>
                                                <td>₹<?php echo $row1['fees'];?>/-          <button class="btn btn-warning b" type="submit" name="submit" value="submit"><b>Pay</b></button></td>
                          <!-- <td><?php echo $row1['installments'];?> </td>
                          
                          <td><?php echo $row1['discount'];?>%</td>
						  <td>₹<?php echo $row1['fine'];?>/-</td>
						  <td>₹<?php echo $row1['consession'];?>/-</td> -->
						 
						

                         
                        
                         <td><a href="playgrp_fees_update.php?id=<?php echo $row1['pfid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
						</td>
												 <?php $i++;  } ?>
                                            </tr>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th></th>
                                            ...
                                            ?>
												<th>Total: ₹<?php echo $data['sumfees'];?>/-   <button class="btn btn-warning b" ype="submit" name="submit" value="submit"><b>Pay</b></th>
