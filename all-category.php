            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
				  ...
				  ?>
					  ...
					  <td><a href="update-category.php?id=<?php echo $row1['cid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
					 
						<a href="delete-category.php?id=<?php echo $row1['cid']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
