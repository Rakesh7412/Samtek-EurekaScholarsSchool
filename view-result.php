                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form action="result.php" method="post" enctype="multipart/form-data" class="new-added-form">
                                    <div class="row">
                                    <div class="col-xl-6 col-lg-8 col-16 form-group">
                                    <label>Roll ID</label>
                                    <input type="text" placeholder="Roll ID" class="form-control" name="rollid">
                                </div>	
                                        <div class="col-xl-6 col-lg-8 col-16 form-group">
...
<?php }} ?>
                                        ...
                                        <div class="col-12 form-group mg-t-8">
                                            <button type="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">View Result</button>
