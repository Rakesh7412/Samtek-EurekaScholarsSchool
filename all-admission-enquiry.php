        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        <div class="heading-layout1">
                            <div class="item-title">
                                <h3>Manage Admission Enquiry</h3>
                            </div>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Enquiry Date</th>
                                            ...
                                            <th>Age</th>
                                            <th>Gender</th>
                                            <th>Enquiry For Grade</th>
                                            <th>Student's Detailed Address</th>
                                            <th>Previous School Name</th>
                                            <th>Previous School Board</th>
                                            ...
                                            <th>How do you come to know about Eureka School?</th>
                                            <th>Enquiry Handled By</th>
                                            <th>Enquiry Type</th>
                                            <th>Remarks by Admission counsellor</th>
                                            <th>Followup</th>
                                            <th>Status</th>
                                            <th>Action</th>
                                            </tr>
				  ...
				  $results1 = mysqli_query($conn, "select * from office_enq");
				  ...
				  ?>
                          ...
                          <td><?php echo $row1['enqdate' ];?> </td>
                          <td><?php echo $row1['childName' ];?> </td>
                          <td><?php echo $row1['age' ];?> </td>
                          <td><?php echo $row1['sgender' ];?> </td>
                          <td><?php echo $row1['class' ];?> </td>
                          <td><?php echo $row1['saddress' ];?> </td>
                          <td><?php echo $row1['PschoolName' ];?> </td>
                          <td><?php echo $row1['PschoolBoard' ];?> </td>
						  <td><?php echo $row1['PschoolLeave' ];?> </td>
                          <td><?php echo $row1['sfname' ];?> </td>
                          <td><?php echo $row1['Occupation' ];?> </td>
                          <td><?php echo $row1['FatherMNo' ];?> </td>
                          <td><?php echo $row1['femail' ];?> </td>
                          <td><?php echo $row1['smname' ];?> </td>
                          <td><?php echo $row1['MOccupation' ];?> </td>
                          <td><?php echo $row1['MotherMNo' ];?> </td>
                          <td><?php echo $row1['memail' ];?> </td>
                          <td><?php echo $row1['Come' ];?> </td>
                          <td><?php echo $row1['enqhandle' ];?> </td>
                          <td><?php echo $row1['enqtype' ];?> </td>
                          <td><?php echo $row1['remark' ];?> </td>
                          <td><?php echo $row1['followup' ];?> </td>
                          <td><?php echo $row1['status' ];?> </td>
                        
                    
						  
						  
                          <td><a href="update-addmission-enquiry.php?enqid=<?php echo $row1['Oid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
					 
                     <a href="delete-all-admission.php?enqid=<?php echo $row1['Oid']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
                      <?php $i++;  } ?>
                                            </tr>
