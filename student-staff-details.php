...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"INSERT INTO transport_student_staff
	(choice,stud_name,staff_name,class,vehicaltype,source,destination,picku,dropu,route,date,charge,pending)VALUES 
	('$choice','$stud_name','$staff_name','$class','$vehicaltype','$source','$destination','$picku
	','$dropu','$route','$date','$charge','$pending')")
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="time" placeholder="" name="picku" class="form-control">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Drop Time</label>
                                    <input type="time" placeholder="" name="dropu" class="form-control">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Routes</label>
                                    <input type="text" placeholder="Routes" name="route" class="form-control">
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Transport Charges" name="charge" class="form-control air-datepicker" data-position='bottom right'>
                                </div>
                                
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Transport Charges Pending</label>
                                    <input type="text" placeholder="Transport Charges Pending" name="pending" class="form-control">
                                </div>
