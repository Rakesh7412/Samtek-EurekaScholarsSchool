        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
				  ...
				  $results1 = mysqli_query($conn, "select * from 1st_fees");
                  ...
                  <tbody>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                          <td><?php echo $row1['fstinstallments' ];?> </td>
                          <td><?php echo $row1['fstfees'];?></td>
                          <td><?php echo $row1['fstdiscount'];?></td>
						  <td><?php echo $row1['fstfine'];?></td>
						  <td><?php echo $row1['fstconsession'];?></td>
						  <td><a href="1st-fees-update.php?id=<?php echo $row1['fstfid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
