                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
									...
									<tr>
										<th>
										 ...
										 <?php
										  ...
										  $results1 = mysqli_query($conn, "select * from staffgate ");
						  ...
						  <td><?php echo $row1['intime'];?></td>
						  <td><?php echo $row1['reason'];?></td>
						  <td><?php echo $row1['date'];?></td>
						  <td><a href="update-staff-gate.php?stfgid=<?php echo $row1['sid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
					 
						  <a href="delete-staff-gate.php?stfgid=<?php echo $row1['sid']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
						  <?php $i++;  } ?>
                     </tr>
                                </tbody>
                            </table>
