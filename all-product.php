                            ...
                            <table class="table display data-table text-nowrap">
                                ...
                                <thead>
									<tr>
										...
										$results1 = mysqli_query($conn, "select * from product");
                                        ...
                                        <td><?php echo $i; ?></td>
											...
											<td><?php echo $row1['SubCategoryName'];?></td>
											<td><?php echo $row1['Dimension'];?></td>
											<td><?php echo $row1['Noofcontents'];?></td>
											<td><?php echo $row1['Specification'];?></td>
											<td><?php echo $row1['code'];?></td>
											<td><?php echo $row1['ColourPrint'];?></td>
											<td><?php echo $row1['ColourCode'];?></td>
											...
											<td><?php echo $row1['ProductInformation'];?></td>
											<td><?php echo $row1['CareInstructions'];?></td>
											<td><?php echo $row1['Price'];?></td>
						  
											<td><a href="update-product.php?productid=<?php echo $row1['proid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
					 
											<a href="delete-product.php?proid=<?php echo $row1['proid']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
											<?php $i++;  } ?>
                                            </tr>
                                </tbody>
                            </table>
