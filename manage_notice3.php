           ...
           <!-- Sidebar Area Start Here -->
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
				  ...
				  $results1 = mysqli_query($conn, "select * from notice3");
				  ...
				  ?>
                           ...
                           <tr>
                          <td><?php echo $i; ?></td>
                          <td><?php echo $row1['notetitle3' ];?> </td>
						  <td><?php echo $row1['notice3'];?></td>
						 
						  <td><a href="update-notice3.php?notice3id=<?php echo $row1['nid3']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
					 
                     <a href="delete-notice3.php?notice3id=<?php echo $row1['nid3']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
                      <?php $i++;  } ?>
                                            </tr>
                            </table>
                        </div>
