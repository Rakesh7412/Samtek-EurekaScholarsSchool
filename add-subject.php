...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"INSERT INTO tblsubjects(SubjectName,SubjectCode)VALUES ('$SubjectName','$SubjectCode')") or die(mysqli_error($conn));
                                ...
                                <form class="new-added-form" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Eg- History,English,Marathi etc" name="SubjectName"required>
                                        </div>
							
                                            <div class="col-12-xxxl col-lg-6 col-12 form-group">
												<label>Subject Code</label>
                                                <input type="text" class="form-control" placeholder="Eg- 301 English,302 Marathi" name="SubjectCode"required>
                                            </div>
