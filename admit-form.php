...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"INSERT INTO studentdetails(sfirstname,smiddlename,slastname,smname,sfname,class,division,campus,semail,smobile,sgender,nationality,scaste,sdob,place_of_birth,saddress,scity,shobbies)VALUES ('$sfirstname','$smiddlename','$slastname','$smname','$sfname','$class','$division','$campus','$semail','$smobile','$sgender','$nationality','$scaste','$sdob','$place_of_birth','$saddress','$scity','$shobbies')") or die(mysqli_error($conn));
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="First Name" name="sfirstname" class="form-control">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Middle Name</label>
                                    <input type="text" placeholder="Middle Name" name="smiddlename" class="form-control">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Last Name</label>
                                    <input type="text" placeholder="Last Name" name="slastname" class="form-control">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Student's Mother Name</label>
                                    <input type="text" placeholder="Mother Name" name="smname" class="form-control">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Student's Father Name</label>
                                    <input type="text" placeholder="Father Name" name="sfname" class="form-control">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                  <label>Class</label>
                                      <div class="col-sm-9">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Student's E-Mail ID" name="semail" class="form-control">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Phone</label>
                                    <input type="text" placeholder="Mobile/Tel" name="smobile" class="form-control">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Gender</label>
                                    <div class="col-sm-18">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Caste</label>
                                    <input type="text" placeholder="Caste" name="scaste" class="form-control">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                ...
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="date" placeholder="dd/mm/yyyy" name="sdob" class="form-control air-datepicker" data-position='bottom right'>
                                   </i>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Birth Place</label>
                                    <input type="text" placeholder="Birth Place" name="place_of_birth" class="form-control">
                                </div>
                                 <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>City</label>
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Hobbies</label>
                                    <input type="text" placeholder="Hobbies" name="shobbies" class="form-control">
                                </div>
