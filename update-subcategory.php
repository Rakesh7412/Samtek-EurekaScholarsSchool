...
if( isset($_POST['submit'])  ) {
	...
	$sql=mysqli_query($conn, "update subcategory set ccname='$ccname',scname='$scname',scode='$scode' where subid='$subid'") or die(mysqli_error($conn));
                            ...
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <?php
				$sql=mysqli_query($conn,"select * from subcategory where subid='$subid'");
				while($row=mysqli_fetch_array($sql)) 
				{
				?>
                 <input type="hidden" class="form-control" name="subid" value="<?php echo $subid; ?>">
										<label>Category Name</label>
												<div class="col-sm-18">
                                                <input type="Category Name" class="form-control" placeholder="Category Name" name="ccname" required value="<?php echo $row['ccname']; ?>">
										...
										<div class="col-12-xxxl col-lg-6 col-12 form-group">
                                                ...
                                                <input type="text" name="scname" class="form-control" placeholder="Sub-Category Name" name="SubjectName"required value="<?php echo $row ['scname']; ?>">
                                            </div>
										<div class="col-12-xxxl col-lg-6 col-12 form-group">
												<label>Sub-Category Code</label>
                                                <input type="text" name="scode" class="form-control" placeholder="Sub-Category Code" name="SubjectName"required value="<?php echo $row ['scode']; ?>">
                                                <?php } ?>
                                            </div>
