                    ...
                    <div class="card-body">
                        ...
                        <form class="mg-b-20">
                            <div class="row gutters-8">
                               ...
                               <a href="add-student-result.php"><button type="submit" class="fw-btn-fill btn-gradient-yellow">ADD NEW</button>
                                </a></div>
                            </div>
                        </form>
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                    ...
                                    <tr>
                                        <th>
										 ...
										 <?php
											...
											$results1 = mysqli_query($conn, "select * from tblstudents");
								...
								<tr>
									...
									<td><?php echo $row1['RollId'];?></td>
									<td><?php echo $row1['StudentEmail'];?></td>
									<td><?php echo $row1['Gender'];?></td>
									<td><?php echo $row1['DOB'];?></td>
                          
									<td><a href="result-update.php?Studentid=<?php echo $row1['StudentId']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
					 
									<a href="result-delete.php?Studentid=<?php echo $row1['StudentId']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
									<?php $i++;  } ?>
                                      </tr>
                                 </tbody>
                            </table>
