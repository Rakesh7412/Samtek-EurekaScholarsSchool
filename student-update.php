...
if( isset($_POST['submit'])  ) {
	...
	$scity=$_POST['scity'];
	$shobbies=$_POST['shobbies'];
	$id=$_POST['sid'];
	
   
	$sql = mysqli_query($conn,"update studentdetails set sfirstname='$sfirstname',smiddlename='$smiddlename',slastname='$smiddlename',smname='$smname',sfname='$sfname',class='$class',division='$division',campus='$campus',semail='$semail' ,smobile='$smobile',sgender='$sgender',nationality='$nationality',scaste='$sdob',sdob='$sdob',place_of_birth='$place_of_birth',saddress='saddress',scity='$scity',shobbies='$shobbies' where sid='$id'") or die(mysqli_error($conn));
	
	if($sql) {
		
		echo "<script type='text/javascript'>alert('Student details added successfully!!..');</script>";
					  echo "<script>document.location='all-student.php'</script>";
	} else {
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
                            <?php
				$sql=mysqli_query($conn,"select * from studentdetails where sid='$id'");
				...
				?>
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Mother Name" name="smname" class="form-control" value="<?php echo $row['smname']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Student's Father Name</label>
                                    <input type="text" placeholder="Father Name" name="sfname" class="form-control" value="<?php echo $row['sfname']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                  <label>Class</label>
                                      <div class="col-sm-9">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Campus</label>
                                    <input type="text" placeholder="Campus" name="campus" class="form-control">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Student's E-Mail ID</label>
                                    <input type="text" placeholder="Student's E-Mail ID" name="semail" class="form-control"value="<?php echo $row['semail']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Phone</label>
                                    <input type="text" placeholder="Mobile/Tel" name="smobile" class="form-control" value="<?php echo $row['smobile']; ?>">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Gender</label>
                                    <div class="col-sm-18">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Caste</label>
                                    <input type="text" placeholder="Caste" name="scaste" class="form-control" value="<?php echo $row['scaste']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                ...
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="date" placeholder="dd/mm/yyyy" name="sdob" class="form-control air-datepicker" data-position='bottom right'value="<?php echo $row['sdob']; ?>">
                                    <i class="far fa-calendar-alt"></i>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Birth Place</label>
                                    <input type="text" placeholder="Birth Place" name="place_of_birth" class="form-control"value="<?php echo $row['place_of_birth']; ?>">
                                </div>
                                 <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>City</label>
                                    <input type="text" placeholder="City" name="scity" class="form-control"value="<?php echo $row['scity']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Hobbies</label>
                                    <input type="text" placeholder="Hobbies" name="shobbies" class="form-control"value="<?php echo $row['shobbies']; ?>">
                                </div>
                                <div class="col-lg-12 col-8 form-group">
                                    <label>Student Detailed Address</label>
                                    <textarea class="textarea form-control" name="saddress" id="form-message" cols="10" rows="8"><?php echo $row['saddress']; ?>"</textarea>
                                </div>
                                <?php } ?>
