        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>Play Group Fees</h3>
                    <ul>
                        <li>
                            <a href="index1.php">Home</a>
                        </li>
                        <li>Play Group Fees</li>
                    </ul>
                </div>
                    ...
                    <div class="card-body">
                        <div class="heading-layout1">
                            <div class="item-title">
                                <h3>Fees Details of Playgroup Class</h3>
                            </div>
				...
				?>
					...
					<option value="6">6</option>
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Fees</label>
                                    <input type="text" placeholder="fees" name="fees" class="form-control" value="<?php echo $row['fees'];?>">
                                </div>
								<input type="hidden" class="form-control" name="pfid" value="<?php echo $pfid; ?>">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Discount</label>
                                    <input type="text" placeholder="discount" name="discount" class="form-control" value="<?php echo $row['discount'];?>">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Fine</label>
                                    <input type="text" placeholder="Fine" name="fine" class="form-control" value="<?php echo $row['fine'];?>">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Consession</label>
                                    <input type="text" placeholder="consession" name="consession" class="form-control" value="<?php echo $row['consession'];?>">
                                </div>
