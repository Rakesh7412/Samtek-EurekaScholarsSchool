           ...
           <!-- Sidebar Area Start Here -->
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
				  ...
				  $i=1;
				  $results1 = mysqli_query($conn, "select * from subcategory");
				  ...
				  ?>
                                        <tbody id="geeks">
                                            <tr>
                                            <td><?php echo $i; ?></td>
                      <td><?php echo $row1['ccname']; ?></td>
					  <td><?php echo $row1['scname'];?></td>
					  <td><?php echo $row1['scode'];?></td>
					
					  <td><a href="update-subcategory.php?subcategoryid=<?php echo $row1['subid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
					 
						<a href="delete-subcategory.php?subcategoryid=<?php echo $row1['subid']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
