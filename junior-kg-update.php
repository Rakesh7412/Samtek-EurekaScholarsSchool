...
if( isset($_POST['submit'])  ) {
	...
	$jinstallments=$_POST['jinstallments'];
	$jfees=$_POST['jfees'];
	$jdiscount=$_POST['jdiscount'];
	$jfine=$_POST['jfine'];
	$jconsession=$_POST['jconsession'];
	$jfid=$_POST['jfid'];
	
	$sql = mysqli_query($conn,"update junior_fees set jinstallments='$jinstallments',jfees='$jfees',jdiscount='$jdiscount',jfine='$jfine',jconsession='$jconsession' where jfid='$jfid'") or die(mysqli_error($conn));
	
	if($sql) {
		
		echo "<script type='text/javascript'>alert('fees details updated successfully!!..');</script>";
					  echo "<script>document.location='junior-kg.php'</script>";
	} else {
		echo "<script type='text/javascript'>alert('error while adding fees details!!..');</script>";
					  echo "<script>document.location='junior_fees.php'</script>";
	} 
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
                            <?php
				$sql=mysqli_query($conn,"select * from junior_fees where jfid='$jfid'");
				...
				?>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <select name="jinstallments" class="form-control">
					<option value="<?php echo$row['jinstallments'];?>"><?php echo $row['jinstallments'];?></option>
					...
					<option value="6">6</option>
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Fees</label>
                                    <input type="text" placeholder="fees" name="jfees" class="form-control" value="<?php echo $row['jfees'];?>">
                                </div>
								<input type="hidden" class="form-control" name="jfid" value="<?php echo $jfid; ?>">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Discount</label>
                                    <input type="text" placeholder="discount" name="jdiscount" class="form-control" value="<?php echo $row['jdiscount'];?>">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Fine</label>
                                    <input type="text" placeholder="Fine" name="jfine" class="form-control" value="<?php echo $row['jfine'];?>">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Consession</label>
                                    <input type="text" placeholder="consession" name="jconsession" class="form-control" value="<?php echo $row['jconsession'];?>">
                                </div>
