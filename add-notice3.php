...
if( isset($_POST['submit'])  ) {
	...
	$notetitle3=$_POST['notetitle3'];
	$notice3=$_POST['notice3'];
	
	
	$sql = mysqli_query($conn,"INSERT INTO notice3(notetitle3,notice3)VALUES ('$notetitle3','$notice3')") or die(mysqli_error($conn));
	
	if($sql) {
		
		echo "<script type='text/javascript'>alert('Notice-3 added successfully!!..');</script>";
                                ...
                                <form class="new-added-form" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Notice Title" name="notetitle3" required>
                                                
                                            </div>
							
                                            <div class="col-12-xxxl col-lg-6 col-12 form-group">
												<label>Add Notice</label>
                                                <input type="text" class="form-control" placeholder="Add Notice" name="notice3" required>
