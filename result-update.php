...
if( isset($_POST['submit'])  ) {
    ...
    $sql = mysqli_query($conn,"update  tblstudents set StudentName='$studentname',rollid='$roolid',gender='$gender' ,dob='$dob',ClassId='$classid' where StudentId='$id'") or die(mysqli_error($conn));
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <?php
				$sql=mysqli_query($conn,"select * from  tblstudents where StudentId='$id'");
				while($row=mysqli_fetch_array($sql)) 
				{
				?>
                 <input type="hidden" class="form-control" name="StudentId" value="<?php echo $id; ?>">
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Student Full Name</label>
                                    <input type="text" placeholder="First Name" name="fullanme" class="form-control" value="<?php echo $row['StudentName']; ?>">
                                </div>
				...
				?>
								<div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Roll No</label>
                                    <input type="text" placeholder="Roll No" name="rollid" class="form-control" value="<?php echo $row['RollId']; ?>">
                                </div>
								<div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Student's E-Mail ID</label>
                                    <input type="email" placeholder="Student's E-Mail ID" name="emailid" class="form-control" value="<?php echo $row['StudentEmail']; ?>">
                                </div>
								<?php } ?>
				...
				?>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="date" placeholder="dd/mm/yyyy" name="dob" class="form-control air-datepicker" data-position='bottom right' value="<?php echo $row['DOB']; ?>">
