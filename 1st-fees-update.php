...
if( isset($_POST['submit'])  ) {
	...
	$fstinstallments=$_POST['fstinstallments'];
	$fstfees=$_POST['fstfees'];
	$fstdiscount=$_POST['fstdiscount'];
	$fstfine=$_POST['fstfine'];
	$fstconsession=$_POST['fstconsession'];
	$fstfid=$_POST['fstfid'];
	
	$sql = mysqli_query($conn,"update 1st_fees set fstinstallments='$fstinstallments',fstfees='$fstfees',fstdiscount='$fstdiscount',fstfine='$fstfine',fstconsession='$fstconsession' where fstfid='$fstfid'") or die(mysqli_error($conn));
	
	if($sql) {
		
		echo "<script type='text/javascript'>alert('fees details updated successfully!!..');</script>";
					  echo "<script>document.location='1st-fees.php'</script>";
	} else {
        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>Junior Kg Fees</h3>
                    <ul>
                        <li>
                            <a href="index1.php">Home</a>
                        </li>
                        <li>Junior Kg Fees</li>
                    </ul>
                </div>
                    ...
                    <div class="card-body">
                        <div class="heading-layout1">
                            <div class="item-title">
                                <h3>Fees Details of Junior Kg</h3>
                            </div>
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
                            <?php
				$sql=mysqli_query($conn,"select * from 1st_fees where fstfid='$fstfid'");
				...
				?>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <select name="fstinstallments" class="form-control">
					<option value="<?php echo$row['fstinstallments'];?>"><?php echo $row['fstinstallments'];?></option>
					...
					<option value="6">6</option>
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Fees</label>
                                    <input type="text" placeholder="fees" name="fstfees" class="form-control" value="<?php echo $row['fstfees'];?>">
                                </div>
								<input type="hidden" class="form-control" name="fstfid" value="<?php echo $fstfid; ?>">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Discount</label>
                                    <input type="text" placeholder="discount" name="fstdiscount" class="form-control" value="<?php echo $row['fstdiscount'];?>">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Fine</label>
                                    <input type="text" placeholder="Fine" name="fstfine" class="form-control" value="<?php echo $row['fstfine'];?>">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Consession</label>
                                    <input type="text" placeholder="consession" name="fstconsession" class="form-control" value="<?php echo $row['fstconsession'];?>">
                                </div>
