            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
				 ...
				 <?php
				  ...
				  $results1 = mysqli_query($conn, "select * from transport");
				  ...
				  ?>
                          ...
                          <td><?php echo $row1['vehicalnumber'];?></td>
                          <td><?php echo $row1['name'];?></td>
						  <td><?php echo $row1['source'];?></td>
						  <td><?php echo $row1['destination'];?></td>
						  <td><?php echo $row1['route'];?></td>
						  <td><?php echo $row1['fuel'];?></td>
						  <td><?php echo $row1['maintainance'];?></td>
						  <td><?php echo $row1['seat'];?></td>
						  
                          <td>
						  <a href="updatevehical.php?vvid=<?php echo $row1['vid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
						  <a href="deletevehical.php?vvid=<?php echo $row1['vid']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
							<?php $i++;  } ?>
								</tr>
                                </tbody>
                            </table>
