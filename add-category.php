                                ...
                                <form class="new-added-form" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                                ...
                                                <input type="fullanme" class="form-control" placeholder="Category Name" name="cname" required>
                                                
                                            </div>
							
                                            <div class="col-12-xxxl col-lg-6 col-12 form-group">
												<label>Category Code</label>
                                                <input type="rollid" class="form-control" placeholder="Category Code" name="ccode" required>
