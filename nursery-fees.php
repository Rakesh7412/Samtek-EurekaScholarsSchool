        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
				  ...
				  $results1 = mysqli_query($conn, "select * from nursery_fees");
                  ...
                  <tbody>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                          <td><?php echo $row1['ninstallments'];?> </td>
                          <td><?php echo $row1['nfees'];?></td>
                          <td><?php echo $row1['ndiscount'];?></td>
						  <td><?php echo $row1['nfine'];?></td>
						  <td><?php echo $row1['nconsession'];?></td>
						  <td><a href="nurseryfees_update.php?id=<?php echo $row1['nfid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
