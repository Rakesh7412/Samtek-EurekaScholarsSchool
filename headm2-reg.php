...
if( isset($_POST['register'])  ) {
	...
	$sql = mysqli_query($conn,"INSERT INTO userslogin(name,email,password,address,cat)VALUES ('$name','$email','$password','$address','headm2')") or die(mysqli_error($conn));
	
	if($sql) {
		
		echo "<script type='text/javascript'>alert('Registered successfully!!..');</script>";
					  echo "<script>document.location='headm2-reg.php'</script>";
	} else {
		echo "<script type='text/javascript'>alert('error while Registering!!..');</script>";
					  echo "<script>document.location='headm2-reg.php'</script>";
	} 
           ...
           <!-- Sidebar Area Start Here -->
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="staffgate.php" class="nav-link"><i class="fas fa-angle-right"></i>Admin(Principal)</a>
                                </li>
                                <li class="nav-item">
                                    <a href="all-staffgate.php" class="nav-link"><i class="fas fa-angle-right"></i>Supervisor</a>
                                </li>
                                <li class="nav-item">
                                    <a href="studentgate.php" class="nav-link"><i class="fas fa-angle-right"></i>Teacher</a>
                                </li>
                                <li class="nav-item">
                                    <a href="all-studentgate.php" class="nav-link"><i class="fas fa-angle-right"></i>Head Mistress1</a>
                                </li>
                                <li class="nav-item">
                                    <a href="parentsgate.php" class="nav-link"><i class="fas fa-angle-right"></i>Head Mistress 2</a>
                                </li>
                                <li class="nav-item">
                                    <a href="all-parentsgate.php" class="nav-link"><i class="fas fa-angle-right"></i>CRM</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>Head Mistress 2 User Register</h3>
                    <ul>
                        <li>
                            <a href="index1.php">Home</a>
                        </li>
                        <li>Head Mistress 2 User Register</li>
                    </ul>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <form class="mt-5 mb-5 login-input" action="" method="post">
								<div class="form-group">
                                        <input type="name" class="form-control" placeholder="Head Mistress 2 Name" name="name" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="email" class="form-control" placeholder="Head Mistress 2 Email" name="email"required>
                                    </div>
                                    <div class="form-group">
									 ...
									 <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control" name="cat" value="<?php echo $cat; ?>">
                                    </div>
                                    
                                    <div class="col-12 form-group mg-t-8">
                                    <button type="submit" name="register" value="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Register</button>
                                </div>
