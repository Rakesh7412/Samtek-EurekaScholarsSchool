...
if( isset($_POST['login'])  ) {
 ...
 if ($conn->connect_error) {
        ...
        $ret=mysqli_query( $conn, "SELECT * FROM userslogin WHERE email='$email' and Password='$password' and cat='headm1'") or die("Could not execute query: " .mysqli_error($conn));
        ...
        if(!$row) {
           ...
           echo "<script>document.location='headm1log.php'</script>";
        }
        else {
...
<body>
  ...
  <center>
  <h1 style="color:#C82128;">Welcome Head Mistrees ESS</h1></center>
<div class="login-box">
  <h2>Head Mistrees 1 Login</h2>
