        ...
        <div class="dashboard-page-one">
                            ...
                            <div class="row align-items-center" >
                                ...
                                <div class="col-6" style="color:blue;">
                                    <div class="item-content">
                                        <div>
                                        <?php
			$sql=mysqli_query($conn,"select COUNT(sid) as sid from studentdetails");
			$row=mysqli_fetch_array($sql);
             ?>
                   
                                        </div>
                                                  <a href="all-student.php"div  class="item-title" >Students</a>
                                        <h2 class="text-white"><?php echo $row['sid'];?></h2>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <a href="fees_structure.php" div class="item-title">Fess Structure</a>
                        ...
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                    <?php
			$sql=mysqli_query($conn,"select COUNT(eid) as eid from enquiry");
			$row=mysqli_fetch_array($sql);
             ?>
                                        <a href="admission_enquiry.php" div class="item-title">Admission</a>
                                        <h2 class="text-white"><?php echo $row['eid'];?></h2>
                        ...
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                    <?php
			$sql=mysqli_query($conn,"select COUNT(tid) as tid from staffdetails");
			$row=mysqli_fetch_array($sql);
             ?>
                                        <a href="all-teacher.php" div class="item-title">All Teacher</a>
                                        <h2 class="text-white"><?php echo $row['tid'];?></h2>
                                        <!-- <div class="item-number"><span class="counter" data-num="5690">5,690</span></div> -->
                                    </div>
                                </div>
                            </div>
				  ...
				  $results1 = mysqli_query($conn, "select * from staffdetails");
                $row1 = mysqli_fetch_array($results1); 
			
				  ?>
                                         <a href="leaveappl.php?tid=<?php echo $row1['tid']; ?>"> <div class="item-title">Leave Application</div></a>
                                        <!-- <div class="item-number"><span>$</span><span class="counter" data-num="193000">1,93,000</span></div> -->
                                    </div>
                                </div>
                            </div>
                ...
                $row1 = mysqli_fetch_array($results1); 
				  ...
				  ?>
                                         <a href="vehical.php" div class="item-title">Transport</a></a>
                                        <!-- <div class="item-number"><span>$</span><span class="counter" data-num="193000">1,93,000</span></div> -->
                                    </div>
                                </div>
                            </div>
			...
			$row=mysqli_fetch_array($sql);
             ?>
                                                  ...
                                                  <a href="vehical.php" div class="item-title" >Attendance</a>
                                        <h2 class="text-white"><?php echo $row['sid'];?></h2>
                                        <!-- <div class="item-number"><span class="counter" data-num="150000">1,50,000</span></div> -->
                                    </div>
                                </div>
			...
			$row=mysqli_fetch_array($sql);
             ?>
                                                  ...
                                                  <a href="vehical.php" div class="item-title">Gate Pass</a>
                                        <h2 class="text-white"><?php echo $row['sid'];?></h2>
                                        <!-- <div class="item-number"><span class="counter" data-num="150000">1,50,000</span></div> -->
                                    </div>
                                </div>
                ...
                <!-- Calender Start Here -->
                <div class="row gutters-20">
				<div class="col-4 col-l-4 col-8-l">
