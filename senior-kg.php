        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
				  ...
				  $results1 = mysqli_query($conn, "select * from senior_fees");
                  ...
                  <tbody>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                          <td><?php echo $row1['sinstallments' ];?> </td>
                          <td><?php echo $row1['sfees'];?></td>
                          <td><?php echo $row1['sdiscount'];?></td>
						  <td><?php echo $row1['sfine'];?></td>
						  <td><?php echo $row1['sconsession'];?></td>
						  <td><a href="senior-kg-update.php?id=<?php echo $row1['sfid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
