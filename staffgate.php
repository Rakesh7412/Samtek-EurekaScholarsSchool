...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"INSERT INTO staffgate(ename,designation,outtime,intime,reason,date)VALUES ('$ename','$designation','$outtime','$intime','$reason','$date')") or die(mysqli_error($conn));
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Name of Employee" name="ename" class="form-control">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>In Time</label>
                                    <input type="time" placeholder="In Time" name="intime" class="form-control">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
