...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="r/css/bootstrap.min.css" media="screen" >
        <link rel="stylesheet" href="r/css/font-awesome.min.css" media="screen" >
        <link rel="stylesheet" href="r/css/animate-css/animate.min.css" media="screen" >
        <link rel="stylesheet" href="r/css/lobipanel/lobipanel.min.css" media="screen" >
        <link rel="stylesheet" href="r/css/prism/prism.css" media="screen" >
        <link rel="stylesheet" href="r/css/main.css" media="screen" >
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">Eureka Schoolar's School</h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
?>
        ...
        <!-- ========== COMMON JS FILES ========== -->
        <script src="rjs/js/jquery/jquery-2.2.4.min.js"></script>
        <script src="rjs/js/bootstrap/bootstrap.min.js"></script>
        <script src="rjs/js/pace/pace.min.js"></script>
        <script src="rjs/js/lobipanel/lobipanel.min.js"></script>
        <script src="rjs/js/iscroll/iscroll.js"></script>
