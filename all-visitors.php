                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
						 ...
						 <?php
							...
							$results1 = mysqli_query($conn, "select * from visitor");
						...
						?>
                            <tbody id="geeks">
                             <tr>
								...
								<td><?php echo $row1['vcontact'];?></td>
								<td><?php echo $row1['vpurpose'];?></td>
								<td><?php echo $row1['vwhom'];?></td>
								<td><?php echo $row1['vrecord'];?></td>
								<td><?php echo $row1['vresponsible'];?></td>
								<td><?php echo $row1['date'];?></td>
                         
								<td><a href="update_visitor.php?visitorid=<?php echo $row1['vid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
					 
								<a href="delete_visitor.php?visitorid=<?php echo $row1['vid']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
						<?php $i++;  } ?>
                                     </tr>
                                  </tbody>
                            </table>
