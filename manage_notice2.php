            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <div class="col-10 form-group mg-t-8">
                                            <a href="manage_notice1.php" button type="submit" name="submit" value="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Notice-1</a>
                                            <a href="manage_notice2.php" button type="submit" name="submit" value="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Notice-2</a>
                                            <a href="manage_notice3.php" button type="submit" name="submit" value="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Notice-3</a>
                                        </div>
                                    
                                        <div class="col-10 form-group mg-t-8">
                                            <a href="add-notice1.php" button type="submit" name="submit" value="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Notice1+</a>
                                            <a href="add-notice2.php" button type="submit" name="submit" value="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Notice2+</a>
                                            <a href="add-notice3.php" button type="submit" name="submit" value="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Notice3+</a>
                                        </div>
                                        <br>
				  ...
				  $results1 = mysqli_query($conn, "select * from notice2");
				  ...
				  ?>
                           ...
                           <tr>
                          <td><?php echo $i; ?></td>
                          <td><?php echo $row1['notetitle2' ];?> </td>
						  <td><?php echo $row1['notice2'];?></td>
						 
						  <td><a href="update-notice2.php?notice2id=<?php echo $row1['nid2']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
					 
                     <a href="delete-notice2.php?notice2id=<?php echo $row1['nid2']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
                      <?php $i++;  } ?>
                                            </tr>
                            </table>
                        </div>
