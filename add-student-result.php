...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"INSERT INTO tblstudents(StudentName,RollId,StudentEmail,Gender,DOB,ClassId,status)VALUES ('$studentname','$roolid','$studentemail','$gender','$dob','$classid',$status)") or die(mysqli_error($conn));
                ...
                <div class="card height-auto">
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Full Name" name="fullanme" class="form-control">
                                </div>
					...
					?>
               		<option value="<?php echo $row ['id']; ?>"><?php echo $row['ClassName']; ?>-<?php echo $row['Section']; ?></option><?php } ?>
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Roll No</label>
                                    <input type="text" placeholder="Roll No" name="rollid" class="form-control">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Student's E-Mail ID</label>
                                    <input type="email" placeholder="Student's E-Mail ID" name="emailid" class="form-control">
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="date" placeholder="dd/mm/yyyy" name="dob" class="form-control air-datepicker" data-position='bottom right'>
