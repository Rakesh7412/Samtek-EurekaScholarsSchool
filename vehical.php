...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"INSERT INTO transport(vehicaltype,vehicalnumber,name,source,destination,route,fuel,maintainance,seat)VALUES ('$vehicaltype','$vehicalnumber','$name','$source','$destination','$route','$fuel','$maintainance','$seat')") or die(mysqli_error($conn));
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Vehicle Number" name="vehicalnumber" class="form-control">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Source</label>
                                    <input type="text" placeholder="Source" name="source" class="form-control">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Daily Fuel Consumption" name="fuel" class="form-control">
                                </div>
								
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Maintainance Cost</label>
                                    <input type="text" placeholder="Maintainance Cost" name="maintainance" class="form-control air-datepicker" data-position='bottom right'>
                                </div>
                                
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Number of Seats</label>
                                    <input type="text" placeholder="Number of Seats" name="seat" class="form-control">
                                </div>
