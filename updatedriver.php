...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"update driverdetails set name='$name',address='$address',adhar='$adhar',paddress='$paddress',licensetype='$licensetype',license='$license',expiry='$expiry',date='$date',vehicaltype='$vehicaltype',previous='$previous' where d_id='$id'") or die(mysqli_error($conn));
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <?php
				$sql=mysqli_query($conn,"select * from driverdetails where d_id='$id'");
				while($row=mysqli_fetch_array($sql)) 
				{
				?>
                 <input type="hidden" class="form-control" name="d_id" value="<?php echo $id; ?>">
                            <div class="row">
							<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Driver Name</label>
                                    <input type="text" placeholder="Driver Name" name="name" class="form-control" value="<?php echo $row['name']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Address</label>
                                    <input type="text" placeholder="Address" name="address" class="form-control" value="<?php echo $row['address']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Adhar Number</label>
                                    <input type="text" placeholder="Adhar Number" name="adhar" class="form-control" value="<?php echo $row['adhar']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Permanent Address</label>
                                    <input type="text" placeholder="Permanent Address" name="paddress" class="form-control" value="<?php echo $row['paddress']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Contact Number</label>
                                    <input type="text" placeholder="Contact Number" name="mobile" class="form-control" value="<?php echo $row['mobile']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="License Number" name="license" class="form-control" value="<?php echo $row['license']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>License Expiry Date</label>
                                    <input type="date" placeholder="License Expiry Date" name="expiry" class="form-control air-datepicker" data-position='bottom right'value="<?php echo $row['expiry']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Date Of Joining</label>
                                    <input type="date" placeholder="Date of Joining" name="date" class="form-control" value="<?php echo $row['date']; ?>">
                                </div>
                               <div class="col-xl-4 col-lg-6 col-12 form-group">
										<label>Vehicle</label>
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Previous Organization" name="previous" class="form-control" value="<?php echo $row['previous']; ?>">
                                </div>
                                <?php } ?>
