...
if( isset($_POST['submit'])  ) {
	...
	$notetitle=$_POST['notetitle1'];
	$notice=$_POST['notice1'];
	
	$id=$_POST['nid1'];
	
	$sql = mysqli_query($conn,"update notice1 set notetitle1='$notetitle',notice1='$notice' where nid1='$id'") or die(mysqli_error($conn));
	
	if($sql) {
		
		echo "<script type='text/javascript'>alert('Notice-1 updated successfully!!..');</script>";
                            ...
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <?php
                                        $sql=mysqli_query($conn,"select * from notice1 where nid1='$id'");
				while($row=mysqli_fetch_array($sql)) 
				{
				?>
                <input type="hidden" class="form-control" name="nid1" value="<?php echo $id; ?>">
												<label>Notice Title</label>
                                                <input type="text" class="form-control" placeholder="Notice Title" name="notetitle1" required value="<?php echo $row['notetitle1']; ?>">
                                                
                                            </div>
							
                                            <div class="col-12-xxxl col-lg-6 col-12 form-group">
												<label>Add Notice</label>
                                                <input type="text" class="form-control" placeholder="Add Notice" name="notice1" required value="<?php echo $row['notice1']; ?>">
