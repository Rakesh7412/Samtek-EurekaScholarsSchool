...
if( isset($_POST['submit'])  ) {
	...
	$tcity=$_POST['tcity'];
    $id=$_POST['tid'];
	$sql = mysqli_query($conn,"update staffdetails set tfirstname='$tfirstname',tmiddlename='$tmiddlename',tlastname='$tlastname',tcampus='$tcampus',temail='$temail',tmobile='$tmobile',tgender='$tgender',tdob='$tdob',taddress='$taddress' ,tcity='$tcity' where tid='$id'") or die(mysqli_error($conn));
                    ...
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <?php
				$sql=mysqli_query($conn,"select * from staffdetails where tid='$id'");
				while($row=mysqli_fetch_array($sql)) 
				{
				?>
                <input type="hidden" class="form-control" name="tid" value="<?php echo $id; ?>">
                <input type="hidden" class="form-control" name="staffid" value="<?php echo $id; ?>">
                                    <label>First Name</label>
                                    <input type="text" placeholder="First Name" name="tfirstname" class="form-control" value="<?php echo $row['tfirstname']; ?>">
                                </div>

                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Middle Name</label>
                                    <input type="text" placeholder="Middle Name" name="tmiddlename" class="form-control" value="<?php echo $row['tmiddlename']; ?>">
                                </div>

                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Last Name</label>
                                    <input type="text" placeholder="Last Name" name="tlastname" class="form-control" value="<?php echo $row['tlastname']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Campus</label>
                                    <input type="text" placeholder="Campus" name="tcampus" class="form-control" value="<?php echo $row['tcampus']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Employee E-Mail ID</label>
                                    <input type="email" placeholder="Employee E-Mail ID" name="temail" class="form-control" value="<?php echo $row['temail']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Phone</label>
                                    <input type="text" placeholder="Mobile/Tel" name="tmobile" class="form-control" value="<?php echo $row['tmobile']; ?>">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Gender</label>
                                    <div class="col-sm-18">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="date" placeholder="dd/mm/yyyy" name="tdob" class="form-control air-datepicker" value="<?php echo $row['tdob']; ?>">
