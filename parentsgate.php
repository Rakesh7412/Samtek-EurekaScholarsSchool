...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"INSERT INTO parentgate(sfirstname,smiddlename,slastname,class,section,person,relation,mobile,reason,date,outtime)VALUES ('$sfirstname','$smiddlename','$slastname','$class','$section','$person','$relation','$mobile','$reason','$date','$outtime')") or die(mysqli_error($conn));
                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                ...
                                <li class="nav-item">
                                    <a href="all-sataffgate.php" class="nav-link"><i class="fas fa-angle-right"></i>All-Staff-Gate-Pass</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Name of Person" name="person" class="form-control">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Relation with Student</label>
                                    <input type="text" placeholder="Relation with Student" name="relation" class="form-control">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Contact No.</label>
                                    <input type="text" placeholder="Mobile/Tel" name="mobile" class="form-control">
                                </div>
                                
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Reason for Going Out</label>
                                    <input type="text" placeholder="Reason for Going Out" name="reason" class="form-control">
                                </div>
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="time" placeholder="Out Time" name="outtime" class="form-control">
                                </div>
