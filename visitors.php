...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"INSERT INTO visitor(vname,vcontact,vpurpose,vwhom,vrecord,vresponsible,date)VALUES ('$vname','$vcontact','$vpurpose','$vwhom','$vrecord','$vresponsible','$date')") or die(mysqli_error($conn));
	
	if($sql) {
		
		echo "<script type='text/javascrdipt'>alert('Visitor's details added successfully!!..');</script>";
		...
		echo "<script type='text/javascript'>alert('error while adding details!!..');</script>";
					  echo "<script>document.location='visitor.php'</script>";
	} 
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Visitor Name" name="vname" class="form-control">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Contact Number</label>
                                    <input type="text" placeholder="Contact Number" name="vcontact" class="form-control">
                                </div>
								
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Purpose Of Visit</label>
                                    <input type="text" placeholder="Purpose Of Visit" name="vpurpose" class="form-control">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Whom you Want to Visit..?</label>
                                    <input type="text" placeholder="Whom you Want to Visit..?" name="vwhom" class="form-control">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Visit Recorded By</label>
                                    <input type="text" placeholder="Visit Recorded By" name="vrecord" class="form-control">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Responsible Person Name</label>
                                    <input type="text" placeholder="Responsible Person Name" name="vresponsible" class="form-control">
                                </div>
