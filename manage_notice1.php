           ...
           <!-- Sidebar Area Start Here -->
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
				  ...
				  $results1 = mysqli_query($conn, "select * from notice1");
				  ...
				  ?>
                           ...
                           <tr>
                          <td><?php echo $i; ?></td>
                          <td><?php echo $row1['notetitle1' ];?> </td>
						  <td><?php echo $row1['notice1'];?></td>
						 
						  <td><a href="update-notice1.php?noticeid=<?php echo $row1['nid1']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
					 
                     <a href="delete-notice1.php?noticeid=<?php echo $row1['nid1']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
                      <?php $i++;  } ?>
                                            </tr>
                            </table>
                        </div>
