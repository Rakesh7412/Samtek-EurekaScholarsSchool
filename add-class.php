...
if( isset($_POST['Submit'])  ) {
	...
	$sql = mysqli_query($conn,"INSERT INTO tblclasses(ClassName,ClassNameNumeric,Section)VALUES ('$ClassName','$ClassNameNumeric','$Section')") or die(mysqli_error($conn));
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Eg- Third,Fouth,Sixth etc" name="ClassName" class="form-control">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Class Name In Numeric</label>
                                    <input type="text" placeholder="Eg- 1,2,4,5 etc" name="ClassNameNumeric" class="form-control">
                                </div>
                                
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Section</label>
                                    <input type="text" placeholder="Eg- A,B,C etc" name="Section" class="form-control">
                                </div>
