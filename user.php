        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
				  ...
				  $results1 = mysqli_query($conn, "select * from userslogin");
				  ...
				  ?>
                     ...
                     <a href="delete-user.php?userid=<?php echo $row1['uid']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
                      <?php $i++;  } ?>
                                            </tr>
