        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
				  ...
				  $results1 = mysqli_query($conn, "select * from junior_fees");
				  ...
				  ?>
                                        ...
                                        <tr>
                                                <td><?php echo $i; ?></td>
                          <td><?php echo $row1['jinstallments'];?> </td>
                          <td><?php echo $row1['jfees'];?></td>
                          <td><?php echo $row1['jdiscount'];?></td>
						  <td><?php echo $row1['jfine'];?></td>
						  <td><?php echo $row1['jconsession'];?></td>
						  <td><a href="junior-kg-update.php?id=<?php echo $row1['jfid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
