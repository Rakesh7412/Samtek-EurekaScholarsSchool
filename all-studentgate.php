                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
									...
									<tr>
										<th>
										 ...
										 <?php
											...
											$results1 = mysqli_query($conn, "select * from studentgate");
                          ...
                          <td><a href="update-student-gate.php?studentgid=<?php echo $row1['sgid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
					 
						  <a href="delete-student-gate.php?studentgid=<?php echo $row1['sgid']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
                      <?php $i++;  } ?>
                                            </tr>
                                </tbody>
                            </table>
