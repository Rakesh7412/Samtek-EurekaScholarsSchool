...
if( isset($_POST['submit'])  ) {
	...
	$notetitle1=$_POST['notetitle2'];
	$notice1=$_POST['notice2'];
	
	
	
   
	$sql = mysqli_query($conn,"INSERT INTO notice2(notetitle2,notice2)VALUES ('$notetitle2','$notice2')") or die(mysqli_error($conn));
	
	if($sql) {
		
		echo "<script type='text/javascript'>alert('Notice-1 added successfully!!..');</script>";
                                ...
                                <form class="new-added-form" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Notice Title" name="notetitle1" required>
                                                
                                            </div>
							
                                            <div class="col-12-xxxl col-lg-6 col-12 form-group">
												<label>Add Notice</label>
                                                <input type="text" class="form-control" placeholder="Add Notice" name="notice1" required>
