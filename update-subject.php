...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"update tblsubjects set SubjectName='$SubjectName',SubjectCode='$SubjectCode' where id='$id'") or die(mysqli_error($conn));
                            ...
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <?php
				$sql=mysqli_query($conn,"select * from tblsubjects where id='$id'");
				while($row=mysqli_fetch_array($sql)) 
				{
				?>
                <input type="hidden" class="form-control" name="id" value="<?php echo $id; ?>">
												<label>Subject Name</label>
                                                <input type="text" class="form-control" placeholder="Eg- History,English,Marathi etc" name="SubjectName"required value="<?php echo $row['SubjectName']; ?>">
                                        </div>
							
                                            <div class="col-12-xxxl col-lg-6 col-12 form-group">
												<label>Subject Code</label>
                                                <input type="text" class="form-control" placeholder="Eg- 301 English,302 Marathi" name="SubjectCode"required value="<?php echo $row['SubjectCode']; ?>">
                                            </div>
											<?php } ?>
