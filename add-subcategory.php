...
if( isset($_POST['submit'])  ) {
	...
	if($sql) {
		...
		echo "<script type='text/javascript'>alert('Successfully not added the subcategory..!');</script>";
					  echo "<script>document.location='add-subcategory.php'</script>";
	}
                                ...
                                <form class="new-added-form" method="post" enctype="multipart/form-data">
                                    <div class="row">
										...
										<label>Category Name</label>
												<div class="col-sm-18">
                                            <select name="ccname" class="form-control">
										...
										<div class="col-12-xxxl col-lg-6 col-12 form-group">
                                                ...
                                                <input type="text" name="scname" class="form-control" placeholder="Sub-Category Name" name="SubjectName"required>
                                            </div>
										<div class="col-12-xxxl col-lg-6 col-12 form-group">
												<label>Sub-Category Code</label>
                                                <input type="text" name="scode" class="form-control" placeholder="Sub-Category Code" name="SubjectName"required>
