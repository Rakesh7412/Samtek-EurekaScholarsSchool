...
if( isset($_POST['submit'])  ) {
	...
	$sinstallments=$_POST['sinstallments'];
	$sfees=$_POST['sfees'];
	$sdiscount=$_POST['sdiscount'];
	$sfine=$_POST['sfine'];
	$sconsession=$_POST['sconsession'];
	$sfid=$_POST['sfid'];
	
	$sql = mysqli_query($conn,"update senior_fees set sinstallments='$sinstallments',sfees='$sfees',sdiscount='$sdiscount',sfine='$sfine',sconsession='$sconsession' where sfid='$sfid'") or die(mysqli_error($conn));
	
	if($sql) {
		
		echo "<script type='text/javascript'>alert('fees details updated successfully!!..');</script>";
					  echo "<script>document.location='senior-kg.php'</script>";
	} else {
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
                            <?php
				$sql=mysqli_query($conn,"select * from senior_fees where sfid='$sfid'");
				...
				?>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <select name="sinstallments" class="form-control">
					<option value="<?php echo$row['sinstallments'];?>"><?php echo $row['sinstallments'];?></option>
					...
					<option value="6">6</option>
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Fees</label>
                                    <input type="text" placeholder="fees" name="sfees" class="form-control" value="<?php echo $row['sfees'];?>">
                                </div>
								<input type="hidden" class="form-control" name="sfid" value="<?php echo $sfid; ?>">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Discount</label>
                                    <input type="text" placeholder="discount" name="sdiscount" class="form-control" value="<?php echo $row['sdiscount'];?>">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Fine</label>
                                    <input type="text" placeholder="Fine" name="sfine" class="form-control" value="<?php echo $row['sfine'];?>">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Consession</label>
                                    <input type="text" placeholder="consession" name="sconsession" class="form-control" value="<?php echo $row['sconsession'];?>">
                                </div>
