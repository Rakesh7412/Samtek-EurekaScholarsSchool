...
if( isset($_POST['submit'])  ) {
	...
	$notetitle2=$_POST['notetitle2'];
	$notice2=$_POST['notice2'];
	
	$id=$_POST['nid2'];
	
	$sql = mysqli_query($conn,"update notice2 set notetitle2='$notetitle2',notice2='$notice2' where nid2='$id'") or die(mysqli_error($conn));
                            ...
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <?php
                                        $sql=mysqli_query($conn,"select * from notice2 where nid2='$id'");
				while($row=mysqli_fetch_array($sql)) 
				{
				?>
                <input type="hidden" class="form-control" name="nid2" value="<?php echo $id; ?>">
												<label>Notice Title</label>
                                                <input type="text" class="form-control" placeholder="Notice Title" name="notetitle2" required value="<?php echo $row['notetitle2']; ?>">
                                                
                                            </div>
							
                                            <div class="col-12-xxxl col-lg-6 col-12 form-group">
												<label>Add Notice</label>
                                                <input type="text" class="form-control" placeholder="Add Notice" name="notice2" required value="<?php echo $row['notice2']; ?>">
