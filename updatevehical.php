...
if( isset($_POST['submit'])  ) {
	...
	$sql = mysqli_query($conn,"update transport set vehicaltype='$vehicaltype',vehicalnumber='$vehicalnumber',name='$name',source='$source',destination='$destination',route='$route',fuel='$fuel',maintainance='$maintainance',seat='$seat' where vid='$id'") or die(mysqli_error($conn));
	
	if($sql) {
		
		echo "<script type='text/javascript'>alert('Vehical details added successfully!!..');</script>";
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <?php
				$sql=mysqli_query($conn,"select * from transport where vid='$id'");
                 ...
                 <input type="hidden" class="form-control" name="vid" value="<?php echo $id; ?>">
                            <div class="row">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Vehicle Number" name="vehicalnumber" class="form-control" value="<?php echo $row['vehicalnumber']; ?>">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
										<label>Driver Name</label>
                                            ...
                                            <select name="name" class="form-control">
												<option value="">Please select</option>
												<?php 
													$sql=mysqli_query($conn,"select * from driverdetails");
													while($row=mysqli_fetch_array($sql)) {
												?>
													<option value="<?php echo $row['d_id']; ?>"><?php echo $row['name']; ?></option><?php } ?>
											</select>
                                        </div>
									</div>
                                    <?php
				...
				?>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Source</label>
                                    <input type="text" placeholder="Source" name="source" class="form-control" value="<?php echo $row['source']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Destination</label>
                                    <input type="text" placeholder="Destination" name="destination" class="form-control" value="<?php echo $row['destination']; ?>">
                                </div>
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Routes</label>
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Daily Fuel Consumption" name="fuel" class="form-control" value="<?php echo $row['fuel']; ?>">
                                </div>
								
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Maintainance Cost</label>
                                    <input type="text" placeholder="Maintainance Cost" name="maintainance" class="form-control air-datepicker" data-position='bottom right'value="<?php echo $row['maintainance']; ?>">
                                </div>
                                
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Number of Seats</label>
                                    <input type="text" placeholder="Number of Seats" name="seat" class="form-control" value="<?php echo $row['seat']; ?>">
                                </div>
                                <?php } ?>
                                <?php } ?>
