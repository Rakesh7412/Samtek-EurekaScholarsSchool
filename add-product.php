...
move_uploaded_file($_FILES["Image4"]["tmp_name"], $target_file4);
 ...
 if (move_uploaded_file($_FILES["Image1"]["tmp_name"], $target_file1)) {
	...
	$sql = mysqli_query($conn,"INSERT INTO product(ProductName,CategoryName,SubCategoryName,Dimension,Noofcontents,Specification,code,ColourPrint,ColourCode,Image1,Image2,Image3,Image4,ProductDescription,ProductInformation,CareInstructions,Price)VALUES ('$ProductName','$CategoryName','$SubCategoryName','$Dimension','$Noofcontents','$Specification','$code','$ColourPrint','$ColourCode','$imgFile1','$imgFile2','$imgFile3','$imgFile4','$ProductDescription','$ProductInformation','$CareInstructions','$Price')") or die(mysqli_error($conn));
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Product Name" name="ProductName" class="form-control air-datepicker" data-position='bottom right'>
                                    </i>
                                </div>
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Dimensions" name="Dimension" class="form-control">
                                </div>
								
								 <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Number of Contents</label>
                                    <input type="text" placeholder="Number of Contents" name="Noofcontents" class="form-control">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Specification</label>
                                    <input type="text" placeholder="Specification" name="Specification" class="form-control">
                                </div>
								...
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Colour/Print" name="ColourPrint" class="form-control">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Colour Code</label>
                                    <input type="text" placeholder="Colour Code" name="ColourCode" class="form-control">
                                </div>
								...
								<div class="col-lg-12 col-8 form-group">
                                    ...
                                    <textarea class="textarea form-control" name="ProductDescription" id="form-message" cols="10" rows="8"></textarea>
                                </div>
								
								<div class="col-lg-12 col-8 form-group">
                                    <label>Product Information</label>
                                    <textarea class="textarea form-control" name="ProductInformation" id="form-message" cols="6" rows="8"></textarea>
                                </div>
								
								<div class="col-lg-12 col-6 form-group">
                                    <label>Care Instructions</label>
                                    <textarea class="textarea form-control" name="CareInstructions" id="form-message" cols="6" rows="8"></textarea>
                                </div>
