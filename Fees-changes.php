        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>Play-Group-Fess-Structure</h3>
                    <ul>
                        <li>
                    ...
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Eg:- 1,2,4,5 etc" name="installment" class="form-control">
                                </div>
								
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Total-Fees-Amout</label>
                                    <input type="text" placeholder="Eg:-Rs:50000/-" name="fess" class="form-control">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Discount</label>
                                    <input type="text" placeholder="Eg:-10%" name="discount" class="form-control">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Fine</label>
                                    <input type="text" placeholder="Eg:-Rs500/-" name="fine" class="form-control">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Consession</label>
                                    <input type="text" placeholder="Eg:-Rs:1000/-" name="Conssesion" class="form-control">
                                </div>
