                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
							...
							<?php
								...
								$results1 = mysqli_query($conn, "select * from parentgate");
                            ...
                            <tr>
								...
								<td><?php echo $row1['smiddlename'];?></td>
								...
								<td><?php echo $row1['outtime'];?></td>
                         
								<td><a href="update-parents-gate.php?parentgid=<?php echo $row1['prntgid']; ?>" ><i class="fa fa-edit" style="font-size: 20px;color: black"></i></a>
					 
								<a href="delete-parentsgate.php?parentgid=<?php echo $row1['prntgid']; ?>" ><i class="fa fa-trash" onclick="doconfirm()" style="font-size: 20px;color: red;" ></i></a></td>
							<?php $i++;  } ?>
                            </tr>
                            </tbody>
                            </table>
