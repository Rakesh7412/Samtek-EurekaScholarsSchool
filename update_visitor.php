...
if( isset($_POST['submit'])  ) {
	...
	$vwhom=$_POST['vwhom'];
	$vrecord=$_POST['vrecord'];
	$vresponsible=$_POST['vresponsible'];
	$date=$_POST['date'];

	$id=$_POST['vid'];
	
	$sql = mysqli_query($conn,"update visitor set vname='$vname',vcontact='$vcontact',vpurpose='$vpurpose',vwhom='$vwhom',vrecord='$vrecord',vresponsible='$vresponsible',date='$date' where vid='$id'") or die(mysqli_error($conn));
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="post" enctype="multipart/form-data">
                            <div class="row">
                            <?php
				$sql=mysqli_query($conn,"select * from visitor where vid='$id'");
                ...
                <input type="hidden" class="form-control" name="vid" value="<?php echo $id; ?>">
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Visitor Name" name="vname" class="form-control" value="<?php echo $row['vname']; ?>">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Contact Number</label>
                                    <input type="text" placeholder="Contact Number" name="vcontact" class="form-control" value="<?php echo $row['vcontact']; ?>">
                                </div>
								
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Purpose Of Visit</label>
                                    <input type="text" placeholder="Purpose Of Visit" name="vpurpose" class="form-control" value="<?php echo $row['vpurpose']; ?>">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Whom you Want to Visit..?</label>
                                    <input type="text" placeholder="Whom you Want to Visit..?" name="vwhom" class="form-control" value="<?php echo $row['vwhom']; ?>">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Visit Recorded By</label>
                                    <input type="text" placeholder="Visit Recorded By" name="vrecord" class="form-control" value="<?php echo $row['vrecord']; ?>">
                                </div>
								
								<div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Responsible Person Name</label>
                                    <input type="text" placeholder="Responsible Person Name" name="vresponsible" class="form-control" value="<?php echo $row['vresponsible']; ?>">
                                </div>
