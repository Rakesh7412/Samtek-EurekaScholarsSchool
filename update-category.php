           ...
           <!-- Sidebar Area Start Here -->
            ...
            <div class="dashboard-content-one">
				...
				?>
                                                ...
                                                <input type="fullanme" class="form-control" placeholder="Category Name" name="cname" required value="<?php echo $row['cname']; ?>">
                                                
                                            </div>
							
                                            <div class="col-12-xxxl col-lg-6 col-12 form-group">
												<label>Category Code</label>
                                                <input type="rollid" class="form-control" placeholder="Category Code" name="ccode" required value="<?php echo $row ['cname']; ?>">
